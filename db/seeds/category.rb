...
lady_5.children.create([{name: "ミニ丈ワンピース"},{name: "ひざ丈ワンピース"},{name: "ロングワンピース"},{name: "その他"}])
...
baby_12 = baby.children.create(name: "ベビー家具/シング/室内用品")
...
cosme_perfume_beauty_3.children.create([{name: "ネイルカラー"},{name: "カラージェル"},{name: "ネイルベースコート/トップコート"},{name: "ネイルアート用品"},{name: "ネイルパーツ"},{name: "ネイルチップ/付け爪"},{name: "手入れ用品"},{name: "除光液"},{name: "その他"}])
